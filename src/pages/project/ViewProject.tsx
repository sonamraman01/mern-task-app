...
const ViewProject = () => {
  const { items, getProjectDetail } = useGetProjectDetails();
      ...
      <div className="mb-4">
        ...
        <div className="mt-9 flex items-center justify-between">
          <div className="">
            ...
            <p className="text-gray-200">{items?.[0]?.title}</p>
          </div>
        ...
        <div className="mt-6">
          ...
          <p className="text-gray-200">{items?.[0]?.client}</p>
        </div>

        <div className="mt-6">
          <h1 className=" font-bold">Description</h1>
          <p className="text-gray-200">{items?.[0]?.description}</p>
        </div>
